        ...
        <!-- Three columns of text below the carousel -->
            <div class="row">
                ...
                <div class="col-lg-6 text-center">
                    ...
                    <p>As an Advocate you are provided with a profile with your name/username, profile picture, e-mail, an "about me" section and a place to share your story. Our main goal for each caregiver is to help out people in need. Reaching out to a patient or creating a digital support group is a great way to get involved in a positive way. </p>
                </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
        </div>
